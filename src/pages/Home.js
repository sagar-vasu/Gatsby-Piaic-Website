...
import ProgramSider from './../componets/programSlider'
// import Paper from "@material-ui/core/Paper"
const Home = props => {
  return (
    <>
      {/* <div className={HomeStyle.section_a}> */}
        <Grid container justifyContent={"center"} style={{ backgroundColor: "rgb(231, 227, 228)" }}>
          <Grid item lg={4} sm={12} xs={12} xl={4} md={4}>
            <img src={PresidentImg} className={HomeStyle.presidentImg} alt="president" />
          </Grid>
          <Grid item xl={8} lg={8} md={8} sm={12} xs={12} >
              <div className={HomeStyle.innderSection_A}>
                <Typography variant="h3" style={{fontWeight:"bold",paddingTop:"40px"}} >
                ...
                <h1 style={{fontWeight: "bolder",width:"150px",float:"right"}}>
                  65K+
                  <span style={{fontSize:12,display:"flex",alignSelf:"flex-end"}}>
